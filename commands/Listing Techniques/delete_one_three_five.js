  ...
  async execute(message, args) {
    await mongodb1().then(async (mongoose) => {
      try {
        ...
        var stringToChannelMessage =
          "All your taskings for 1-3-5 have been refreshed and removed. You can now start a new session by typing '!1-3-5'. All the best for your next session! :smile:";
